...
LOCATIONS = [
    ...
    },
    {
        ...
        "type": "residence",
        "family_members": ["Joseph Hamilton Hopper (Uncle Joe)", "George Dunlap Hopper", "Blackgrove Hopper"],
        "events": ["Uncle Joe Hopper born (July 22, 1829)", "George Dunlap Hopper born (October 29, 1848)", "Blackgrove Hopper died (April 1831)"],
        "date_range": "1829-1869",
        "description": "Important Hopper family location in Garrard County. Birthplace of both Uncle Joe Hopper (1829) and George Dunlap Hopper (1848). Blackgrove Hopper (1759-1831), son of Joseph Hopper and Elizabeth, died here in April 1831 at age 71.",
